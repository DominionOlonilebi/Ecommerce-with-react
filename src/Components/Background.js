          ...
          <Container>
            <Row>
              <Col md={7} sm={12}>
                ...
                <p>
                  Join over 1000 connected homes and business that have
                  eliminated generators and are now saving with solarcorp
                </p>
                ...
                <div className="listing_list">
                  ...
                  />
                  &nbsp; &nbsp;
                  <span className="list">Trusted across 25 Cities</span>
                  <span className="listing">
                    ...
                    />
                    &nbsp; &nbsp;
                    <span className="lists">5,000 Homes Powered</span>
                  </span>
                </div>
              </Col>
              <Col md={5} sm={12}>
